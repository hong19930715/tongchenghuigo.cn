    ...
    public function settingsDisplay($settings) {  
        ...
        if (checksubmit()) {
            $cfg = array(
                ...
                'describer' => $_GPC['describer'],//店名
                'sckaiqi' => $_GPC['sckaiqi'],  //商城是否在前端显示字段
                'zstitle' => $_GPC['zstitle'],  //招商标题
                'zsdescriber' => $_GPC['zsdescriber'],  //招商描述
                'zstelphone' => $_GPC['zstelphone'],  //招商热线
                'shopthumb' => $_GPC['shopthumb'],//店招牌

                'shname' => $_GPC['shname'],  //商户名称
                'telphone' => $_GPC['telphone'],  //联系方式
                'address' => $_GPC['address'],  //提货地址
                'thtime' => $_GPC['thtime'],  //提货时间
            );
